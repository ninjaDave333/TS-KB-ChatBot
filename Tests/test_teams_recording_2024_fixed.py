...
def test_2024_queries():
    ...
    try:
        ...
        print(f"   [OK] {count} external meetings recorded in 2024")
    ...
    try:
        ...
        if result2:
            ...
            print(f"   [OK] Total: {total}, Internal: {internal}, External: {external}")
        else:
            print("   [OK] No meetings found for David")
    except Exception as e:
        print(f"   [ERROR] {e}")
    ...
    try:
        ...
        if result3:
            ...
            print(f"   [OK] Most active: {name} ({total} total: {owned} owned, {participated} participated)")
        else:
            print("   [OK] No 2024 meeting data found")
    except Exception as e:
        print(f"   [ERROR] {e}")
    ...
    try:
        ...
        if result4:
            ...
            print(f"   [OK] Most active in July 2024: {name} ({total} total: {owned} owned, {participated} participated)")
        else:
            print("   [OK] No July 2024 meeting data found")
    except Exception as e:
        print(f"   [ERROR] {e}")
    ...
    try:
        ...
        if result5:
            ...
            print("   [OK] No client meeting data found")
    except Exception as e:
        print(f"   [ERROR] {e}")
